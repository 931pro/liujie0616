<%@ page import="com.LiuJie.Model.Product" %>
<%@ page import="java.util.List" %>
<%@include file="header.jsp" %>
<%@taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
<%
	List<Product> arr=(List)pageContext.findAttribute("productList");
							...
							<div class="product-image-wrapper">
								<div class="single-products">
									<div class="productinfo text-center">
										...
										<h2>${p.price}</h2>
										<p>${p.productName}</p>
										<a href="<%=basePath%>id=p.productId" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
									</div>
