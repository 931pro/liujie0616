			...
			<div class="table-responsive col-sm-10">
				...
				<thead>
					...
					<c:forEach var="o" items="${orderList}">
						...
						<td>${o.orderDate}</td>
						<%
							com.LiuJie.Model.Order o=(com.LiuJie.Model.Order)pageContext.findAttribute("o");
							int userId=o.getCustomerId();
							java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
							com.LiuJie.Dao.UserDao userDao=new com.LiuJie.Dao.UserDao();
						...
						<%
							...
							String paymentType=com.LiuJie.Model.Payment.findByPaymentId(con,n);
							 %>
